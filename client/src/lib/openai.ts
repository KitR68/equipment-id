...
export async function extractNameplate(
  ...
  const userText = [
    ...
    '                                   //  "402024_2009375"). If the nameplate has a field labeled',
    '                                   //  DATE CODE or D/C, put its value here even if it looks long.',
    ...
    "- A date code is a field that encodes the manufacture date separately from the serial number.",
    "  It may be short (e.g. \"2305\", \"A14\") or longer (e.g. \"402024_2009375\").",
    "  If the nameplate has a field explicitly labeled DATE CODE, D/C, or similar,",
    "  ALWAYS place that value in dateCode — regardless of its length or format.",
